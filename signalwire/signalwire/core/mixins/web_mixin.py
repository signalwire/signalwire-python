                ...
                if isinstance(result, FunctionResult):
                    ...
                    req_log.warning(
                        ...
                        hint=(
                            ...
                            "The AI will see the stringified value (e.g. "
                            "'<MyType object at 0x...>') as its tool response. "
                            "Wrap your return in FunctionResult(...) or return a "
                            "dict with at least a 'response' key."
                        ),
                    )
