...
class ReceptionistAgent(AgentBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.set_global_data({"departments": departments, "caller_info": {}})
    ...
    def _collect_caller_info_handler(self, args, raw_data):
        ...
        result.add_actions(
            [{"set_global_data": {"caller_info": {"name": name, "reason": reason}}}]
        )
    ...
    def _transfer_call_handler(self, args, raw_data):
        ...
        if not department:
            return FunctionResult(
                f"Sorry, I couldn't find the {department_name} department."
            )
