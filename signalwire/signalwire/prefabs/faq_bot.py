...
class FAQBotAgent(AgentBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.persona = (
            persona
            or "You are a helpful FAQ bot that provides accurate answers to common questions."
        )
    ...
    def _build_faq_bot_prompt(self):
        ...
        for faq in self.faqs:
            ...
            faq_subsections.append({"title": question, "body": body_text})
    ...
    def _configure_agent_settings(self):
        ...
        self.set_params(
            {"wait_for_user": False, "end_of_speech_timeout": 1000, "ai_volume": 5}
        )
    ...
    def search_faqs(self, args, raw_data):
        ...
        for faq in self.faqs:
            ...
            if match_score > 0:
                results.append({"question": faq.get("question"), "score": match_score})
