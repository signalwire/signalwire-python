...
(``from signalwire.signalwire.rest.namespaces.datasphere import DatasphereDocuments``) working. New code
should import from the generated module / use ``client.datasphere`` instead. PYTHON-ONLY: the
...
from ._client_tree_generated import DatasphereNamespace
