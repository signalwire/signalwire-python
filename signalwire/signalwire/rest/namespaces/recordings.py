...
(``from signalwire.signalwire.rest.namespaces.recordings import RecordingsResource``) working. New code
should import from the generated module / use ``client.recordings`` instead. PYTHON-ONLY: the
surface oracle skips this file (the marker above), so no other port implements these.
"""

from .relay_rest_resources_generated import Recordings
