...
re-export keeps ``from signalwire.rest.namespaces.verified_callers import VerifiedCallersResource``
...
warnings.warn(
    "signalwire.rest.namespaces.verified_callers is deprecated; use client.verified_callers. "
