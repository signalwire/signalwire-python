...
re-export keeps ``from signalwire.rest.namespaces.phone_numbers import PhoneNumbersResource``
...
warnings.warn(
    "signalwire.rest.namespaces.phone_numbers is deprecated; use client.phone_numbers. "
