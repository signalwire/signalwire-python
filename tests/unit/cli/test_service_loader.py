...
def _make_mock_agent(
    name: str = "test_agent", route: str = "/agent", class_name: str = "TestAgent"
) -> Mock:
...
class TestServiceCapturePatching:
    ...
    def test_apply_patches_stores_originals(self, capturer: ServiceCapture) -> None:
    ...
    def test_apply_patches_replaces_methods(self, capturer: ServiceCapture) -> None:
    ...
    def test_restore_patches_clears_dict(self, capturer: ServiceCapture) -> None:
        """_restore_patches clears the original_methods dict."""
        capturer._apply_patches()
        capturer._restore_patches()
        assert capturer.original_methods == {}

    def test_restore_patches_with_empty_dict(self, capturer: ServiceCapture) -> None:
    ...
    def test_mock_run_captures_service(self, capturer: ServiceCapture) -> None:
    ...
    def test_mock_serve_returns_service(self, capturer: ServiceCapture) -> None:
        """The patched serve() method returns the service instance."""
        capturer._apply_patches()
        try:
            svc = SWMLService(name="return_test", route="/rt", schema_validation=False)
            result = svc.serve()  # type: ignore[func-returns-value]  # test stubs serve() to return self
...
class TestLoadAndSimulateService:
    ...
    def test_no_services_raises_value_error(self, tmp_path: Path) -> None:
    ...
    def test_multiple_services_no_route_raises_value_error(self) -> None:
    ...
    def test_single_service_selected_automatically(self) -> None:
    ...
    def test_multiple_services_available_routes_in_error(self) -> None:
...
class TestLoadAgentFromFile:
    ...
    def test_no_agents_raises_value_error(self) -> None:
    ...
    def test_multiple_agents_returns_first(self) -> None:
    ...
    def test_multiple_agents_with_class_name(self) -> None:
    ...
    def test_class_name_no_match_returns_first(self) -> None:
    ...
    def test_filters_non_agents(self) -> None:
    ...
    def test_suppress_output_forwarded(self) -> None:
...
class TestDiscoverAgentsInFile:
    ...
    def test_filters_non_agent_services(self) -> None:
...
class TestSimulateRequestToService:
    ...
    @pytest.mark.asyncio
    async def test_simulate_returns_dict_response(self) -> None:
        """When the service handler returns a dict, it's returned as-is."""
        mock_service = Mock()

        async def async_handler(request: Any, response: Any) -> dict[str, Any]:
            return {"swml": "data"}
    ...
    async def test_simulate_returns_body_response(self) -> None:
        ...
        async def async_handler(request: Any, response: Any) -> Any:
            return response_obj
    ...
    @pytest.mark.asyncio
    async def test_simulate_returns_error_for_unparseable(self) -> None:
        """When the response is neither dict nor has body, return error dict."""
        mock_service = Mock()

        async def async_handler(request: Any, response: Any) -> str:
