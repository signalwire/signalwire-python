...
class TestSchemaUtils:
    ...
    def test_initialization_without_schema_path(self) -> None:
        ...
        with (
            patch.object(
                ...
                return_value="/default/schema.json",
            ),
    ...
    def test_load_schema_success(self) -> None:
        ...
        schema_data = {
            "$defs": {
                "SWMLMethod": {"anyOf": [{"$ref": "#/$defs/AIMethod"}]},
                "AIMethod": {"properties": {"ai": {"type": "object"}}},
            }
        }
...
class TestVerbExtraction:
    ...
    def test_extract_verb_definitions_no_anyof(self) -> None:
        ...
        schema: dict[str, Any] = {"$defs": {"SWMLMethod": {"properties": {}}}}
...
class TestVerbProperties:
    ...
    def test_get_verb_parameters_existing(self) -> None:
        ...
        expected = {"prompt": {"type": "string"}, "temperature": {"type": "number"}}
        assert result == expected
...
class TestCodeGeneration:
    ...
    def test_generate_method_signature(self) -> None:
        ...
        assert (
            "def ai(self, prompt: str, temperature: Optional[float] = None, **kwargs) -> bool:"
            in result
        )
    ...
    def test_get_type_annotation_anyof(self) -> None:
        ...
        param_def = {"anyOf": [{"type": "string"}, {"type": "integer"}]}
