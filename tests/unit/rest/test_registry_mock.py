...
class TestRegistryBrands:
    ...
    def test_list_campaigns_uses_brand_subpath(self, signalwire_client: RestClient, mock: _MockHarness) -> None:
    ...
    def test_create_campaign_posts_to_brand_subpath(self, signalwire_client: RestClient, mock: _MockHarness) -> None:
...
class TestRegistryCampaigns:
    ...
    def test_update_uses_put(self, signalwire_client: RestClient, mock: _MockHarness) -> None:
    ...
    def test_list_numbers_uses_numbers_subpath(self, signalwire_client: RestClient, mock: _MockHarness) -> None:
    ...
    def test_create_order_posts_to_orders_subpath(self, signalwire_client: RestClient, mock: _MockHarness) -> None:
...
class TestRegistryNumbers:
    ...
    def test_delete_uses_id_in_path(self, signalwire_client: RestClient, mock: _MockHarness) -> None:
