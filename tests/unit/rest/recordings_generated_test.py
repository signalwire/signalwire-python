"""AUTO-GENERATED REST wire tests for the `recordings` namespace — DO NOT EDIT.
...
class TestRecordingsWire:
    ...
    def test_recordings_delete_error(
        ...
        mock.push_scenario("relay-rest.delete_recording", 500, {"error": "x"})
    ...
    def test_recordings_get(
        ...
        signalwire_client.recordings.get("test-id")
        last = mock.last_request()
    ...
    def test_recordings_get_error(
        ...
        mock.push_scenario("relay-rest.get_recording", 500, {"error": "x"})
        with pytest.raises(SignalWireRestError) as exc:
            signalwire_client.recordings.get("test-id")
        assert exc.value.status_code == 500
    ...
    def test_recordings_list_error(
        ...
        mock.push_scenario("relay-rest.list_recordings", 500, {"error": "x"})
        with pytest.raises(SignalWireRestError) as exc:
            signalwire_client.recordings.list()
        assert exc.value.status_code == 500
