...
class TestFabricResources:
    def test_ai_agents_list(self, client: RestClient, mock_session: MagicMock) -> None:
        ...
        mock_session.request.assert_called_with(
            "GET",
            "https://test.signalwire.com/api/fabric/resources/ai_agents",
            json=None,
            params=None,
            timeout=30.0,
        )
    ...
    def test_ai_agents_update_uses_patch(
        self, client: RestClient, mock_session: MagicMock
    ) -> None:
        ...
        mock_session.request.assert_called_with(
            "PATCH",
            "https://test.signalwire.com/api/fabric/resources/ai_agents/id-1",
            json={"name": "Updated"},
            params=None,
            timeout=30.0,
        )

    def test_swml_scripts_update_uses_put(
        self, client: RestClient, mock_session: MagicMock
    ) -> None:
        mock_session.request.return_value = MockResponse(200, {})
        ...
        mock_session.request.assert_called_with(
            "PUT",
            "https://test.signalwire.com/api/fabric/resources/swml_scripts/id-1",
            json={"contents": "{}"},
            params=None,
            timeout=30.0,
        )
    ...
    def test_list_addresses(self, client: RestClient, mock_session: MagicMock) -> None:
        ...
        mock_session.request.assert_called_with(
            "GET",
            "https://test.signalwire.com/api/fabric/resources/ai_agents/id-1/addresses",
            json=None,
            params=None,
            timeout=30.0,
        )
...
class TestFabricSubscribers:
    def test_list_sip_endpoints(
        ...
        mock_session.request.assert_called_with(
            "GET",
            "https://test.signalwire.com/api/fabric/resources/subscribers/sub-1/sip_endpoints",
            json=None,
            params=None,
            timeout=30.0,
        )

    def test_create_sip_endpoint(
        self, client: RestClient, mock_session: MagicMock
    ) -> None:
        mock_session.request.return_value = MockResponse(201, {"id": "ep-1"})
        client.fabric.subscribers.create_sip_endpoint(
            "sub-1", username="user1", password="s3cret"
        )
        mock_session.request.assert_called_with(
            "POST",
            "https://test.signalwire.com/api/fabric/resources/subscribers/sub-1/sip_endpoints",
            json={"username": "user1", "password": "s3cret"},
            params=None,
            timeout=30.0,
        )
...
class TestGenericResources:
    def test_assign_phone_route_posts(
        self, client: RestClient, mock_session: MagicMock
    ) -> None:
        ...
        mock_session.request.assert_called_with(
            "POST",
            "https://test.signalwire.com/api/fabric/resources/res-1/phone_routes",
            json={"phone_route_id": "pr-1", "handler": "calling"},
            params=None,
            timeout=30.0,
        )
...
class TestWebhooks:
    ...
    def test_swml_webhooks_create_no_warning(
        self,
        client: RestClient,
    ...
    def test_cxml_webhooks_create_no_warning(
        self,
        client: RestClient,
        mock_session: MagicMock,
        recwarn: pytest.WarningsRecorder,
    ...
    def test_webhooks_read_update_delete_work_without_warning(
        self, client: RestClient, mock_session: MagicMock
    ) -> None:
...
class TestFabricTokens:
    def test_create_subscriber_token(
        self, client: RestClient, mock_session: MagicMock
    ) -> None:
        ...
        mock_session.request.assert_called_with(
            "POST",
            "https://test.signalwire.com/api/fabric/subscribers/tokens",
            json={"reference": "user@example.com"},
            params=None,
            timeout=30.0,
        )
    ...
    def test_create_guest_token(
        ...
        mock_session.request.assert_called_with(
            "POST",
            "https://test.signalwire.com/api/fabric/guests/tokens",
            json={"allowed_addresses": ["addr-1"]},
            params=None,
            timeout=30.0,
        )
