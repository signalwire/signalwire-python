...
class TestVideoRoomsStreams:
    ...
    def test_list_streams_returns_data_collection(
    ...
    def test_create_stream_posts_kwargs_in_body(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
...
class TestVideoRoomSessions:
    ...
    def test_get_returns_session_object(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
    ...
    def test_list_events_uses_events_subpath(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
    ...
    def test_list_recordings_uses_recordings_subpath(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
...
class TestVideoRoomRecordings:
    ...
    def test_get_returns_single_recording(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
...
class TestVideoConferences:
    ...
    def test_list_conference_tokens(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
...
class TestVideoConferenceTokens:
    ...
    def test_get_returns_single_token(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
    ...
    def test_reset_posts_to_reset_subpath(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
...
class TestVideoStreams:
    ...
    def test_get_returns_stream_resource(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
    ...
    def test_update_uses_put_with_kwargs(
        self, signalwire_client: RestClient, mock: _MockHarness
    ) -> None:
