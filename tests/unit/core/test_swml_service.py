...
class TestSWMLServiceInitialization:
    ...
    def test_basic_initialization(self) -> None:
        ...
        service = SWMLService(
            name="test_service", route="/test", host="127.0.0.1", port=3001
        )
    ...
    def test_initialization_with_schema_path(self) -> None:
        ...
        service = SWMLService(name="test_service", schema_path="/path/to/schema.json")
    ...
    def test_initialization_with_basic_auth(self) -> None:
        ...
        service = SWMLService(name="test_service", basic_auth=("user", "pass"))
...
class TestSWMLServiceVerbMethods:
    ...
    def test_add_verb_with_config(self, mock_swml_service: SWMLService) -> None:
        ...
        config = {"url": "https://example.com/audio.mp3", "volume": 0.8, "loop": 3}
    ...
    def test_add_verb_to_section(self, mock_swml_service: SWMLService) -> None:
        ...
        result = mock_swml_service.add_verb_to_section(
            "custom_section", "play", {"url": "test.mp3"}
        )
...
class TestSWMLServiceUtilityMethods:
    ...
    def test_basic_auth_credentials_with_source(
...
class TestSWMLServiceSpecialVerbs:
    ...
    def test_add_ai_verb(self, mock_swml_service: SWMLService) -> None:
        ...
        result = mock_swml_service.add_verb(
            "ai",
            {
                "prompt": {"text": "You are a helpful assistant"},
                "post_prompt": {"text": "Thank you for using our service"},
            },
        )
...
class TestSWMLServiceIntegration:
    ...
    def test_json_serialization_of_document(
        self, mock_swml_service: SWMLService
    ) -> None:
...
class TestCreateVerbMethods:
    ...
    def test_verb_methods_cache_populated(self, mock_swml_service: SWMLService) -> None:
        ...
        if (
            mock_swml_service.schema_utils
            and mock_swml_service.schema_utils.get_all_verb_names()
        ):
            assert len(mock_swml_service._verb_methods_cache) > 0

    def test_known_verbs_exist_as_attributes(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_verb_method_adds_verb_to_document(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_verb_method_strips_none_kwargs(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_sleep_verb_raises_without_duration(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_sleep_verb_accepts_kwargs_fallback(
        self, mock_swml_service: SWMLService
    ) -> None:
...
class TestGetAttr:
    ...
    def test_getattr_error_message_includes_class_name(
        self, mock_swml_service: SWMLService
    ) -> None:
...
class TestProxyDetection:
    ...
    def _make_request(
        ...
        url: str = "http://127.0.0.1:3001/test",
    ) -> Mock:
    ...
    def test_x_forwarded_host_default_proto(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_rfc7239_forwarded_header_http_default(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_rfc7239_forwarded_no_host_ignored(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_host_header_with_external_host(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_host_header_with_local_host_ignored(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_no_proxy_headers_returns_none(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_already_set_proxy_not_overridden(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_forwarded_header_parse_error_handled(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_multiple_proxy_hops_x_forwarded(
        self, mock_swml_service: SWMLService
    ) -> None:
...
class TestServe:
    ...
    @patch("signalwire.core.swml_service.uvicorn", create=True)
    def test_serve_prints_startup_info(
        self, mock_uvicorn_module: MagicMock, capsys: pytest.CaptureFixture[str]
    ) -> None:
...
class TestSectionManagement:
    ...
    def test_add_duplicate_section_returns_false(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_main_section_exists_by_default(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_add_section_creates_empty_list(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_add_duplicate_main_returns_false(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_add_verb_to_section_auto_creates_section(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_add_verb_to_section_invalid_config_type(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_verbs_in_different_sections_independent(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_add_verb_main_section_by_default(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_render_document_includes_all_sections(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_add_verb_non_dict_config_returns_false(
        self, mock_swml_service: SWMLService
    ) -> None:
    ...
    def test_add_verb_to_section_sleep_int_config(
        self, mock_swml_service: SWMLService
    ) -> None:
...
class TestFullValidationEnabled:
    ...
    def test_full_validation_with_schema_utils(
        self, mock_swml_service: SWMLService
    ) -> None:
...
class TestRegisterVerbHandler:
    ...
    def test_register_verb_handler(self, mock_swml_service: SWMLService) -> None:
        ...
        mock_swml_service.verb_registry.register_handler.assert_called_once_with(
            mock_handler
        )
...
class TestGetBasicAuthEnvironmentSource:
    ...
    def test_provided_source(self) -> None:
        ...
        # "provided" classifies the SOURCE (they match no env var); the
...
class TestServeCatchAllRoute:
    ...
    @patch("signalwire.core.swml_service.uvicorn", create=True)
    def test_catch_all_with_routing_callback_subpath(
...
class TestDecomposedHandleRequestCore:
    ...
    def test_core_307_matches_fastapi_path(self) -> None:
        ...
        svc = self._svc()
        svc.register_routing_callback(lambda body, headers: "/other-agent", "/sip")
        core_status, core_headers, _ = svc.handle_request(
            "POST",
            "http://127.0.0.1:3001/sip",
            _auth_header("u", "p"),
