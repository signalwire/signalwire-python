...
class TestSkillManagerLoading:
    ...
    def test_load_skill_with_params(self, mock_agent: AgentBase) -> None:
        ...
        success, error = skill_manager.load_skill(
            "mock_skill", MockSkill, params=params
        )
    ...
    def test_load_skill_initialization_error(self, mock_agent: AgentBase) -> None:
        ...
        class BrokenSkill(SkillBase):
            ...
            def __init__(
                self, agent: AgentBase, params: dict[str, Any] | None = None
            ) -> None:
...
class TestSkillManagerValidation:
    ...
    def test_validate_skill_with_env_vars(
        self, mock_agent: AgentBase, mock_env_vars: dict[str, str]
    ) -> None:
