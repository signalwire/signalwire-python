...
class TestInferSchemaTypes:
    ...
    def test_optional_param(self) -> None:
        def handler(name: str, nickname: str | None = None) -> None:
            pass
...
class TestInferSchemaRequired:
    ...
    def test_optional_type_is_not_required(self) -> None:
        def handler(city: str | None) -> None:
            pass
    ...
    def test_mixed_required_optional(self) -> None:
        def handler(
            city: str, units: str = "celsius", country: str | None = None
        ) -> None:
            pass
...
class TestInferSchemaRawData:
    ...
    def test_raw_data_detected(self) -> None:
        def handler(city: str, raw_data: dict[str, Any] | None = None) -> None:
            pass
...
class TestCreateTypedHandlerWrapper:
    ...
    def test_wrapper_passes_raw_data(self) -> None:
        def handler(
            city: str, raw_data: dict[str, Any] | None = None
        ) -> FunctionResult:
...
class TestEndToEndIntegration:
    ...
    def test_typed_handler_with_raw_data(self) -> None:
        ...
        class TestAgent(AgentBase):
            ...
            def check_call(
                self, query: str, raw_data: dict[str, Any] | None = None
            ) -> FunctionResult:
                """Check the call.
        ...
        agent = TestAgent()
        result = agent.on_function_call(
            "check_call", {"query": "test"}, {"call_id": "c42"}
        )
        assert isinstance(result, FunctionResult)
    ...
    def test_literal_enum_in_swml(self) -> None:
        ...
        class TestAgent(AgentBase):
            ...
            def set_mode(
                self, mode: Literal["auto", "manual", "off"]
            ) -> FunctionResult:
