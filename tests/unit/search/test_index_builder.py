...
class TestIndexBuilderFileDiscovery:
    ...
    def test_discover_files_from_directory(self, mock_exists: MagicMock, mock_rglob: MagicMock, mock_is_dir: MagicMock) -> None:
    ...
    def test_discover_files_from_individual_files(self, mock_is_file: MagicMock, mock_is_dir: MagicMock) -> None:
    ...
    @patch('pathlib.Path.is_dir')
    @patch('pathlib.Path.is_file')
    def test_discover_files_with_exclusions(self, mock_is_file: MagicMock, mock_is_dir: MagicMock) -> None:
        ...
        result = self.builder._discover_files_from_sources(sources, file_types, exclude_patterns)  # type: ignore[arg-type]  # mock Path objects
...
class TestIndexBuilderDatabaseCreation:
    ...
    def test_create_database_with_numpy_embedding_dimensions(self, mock_np: MagicMock) -> None:
