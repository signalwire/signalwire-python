    ...
    def test_vectorize_query_success(self) -> None:
        ...
        with patch(
            ...
            mock_model.encode.assert_called_once_with(
                "test query", show_progress_bar=False
            )
...
class TestNLTKResources:
    ...
    def test_ensure_nltk_resources_download_needed(self, mock_nltk: MagicMock) -> None:
        ...
        assert (
            mock_nltk.download.call_count == 5
        )  # punkt, punkt_tab, wordnet, averaged_perceptron_tagger, stopwords
...
class TestQueryPreprocessing:
    ...
    def test_preprocess_query_basic(
        self, mock_load_spacy: MagicMock, mock_detect_lang: MagicMock
    ) -> None:
    ...
    def test_preprocess_query_with_vector(
        self, mock_vectorize: MagicMock, mock_detect_lang: MagicMock
    ) -> None:
    ...
    @patch("signalwire.search.query_processor.load_spacy_model")
    def test_preprocess_query_with_synonym_expansion(
        self, mock_load_spacy: MagicMock, mock_get_synonyms: MagicMock
    ) -> None:
...
class TestDocumentPreprocessing:
    ...
    @patch("signalwire.search.query_processor.load_spacy_model")
    def test_preprocess_document_content_basic(
        self, mock_load_spacy: MagicMock
    ) -> None:
    ...
    @patch("signalwire.search.query_processor.load_spacy_model")
    def test_preprocess_document_content_with_spacy(
        self, mock_load_spacy: MagicMock
    ) -> None:
...
class TestErrorHandling:
    ...
    @patch("signalwire.search.query_processor.vectorize_query")
    def test_preprocess_query_vectorization_error(
